  ...
  async sendSms(createMailDto: CreateMailDto) {
    ...
    switch (createMailDto.type) {
      ...
      case mailEnums.JOINING.toString():
        message = `Congratulations! ${createMailDto.value?.split("|")[0]} Welcome to Anamika Capital Finance Pvt. Ltd. Your Joining has been Accepted By Company. Your EMP ID ${createMailDto.value?.split("|")[1]}, pass-${createMailDto.value?.split("|")[2]} caslon &templateid=1707169985689943172`;
        break;
