...
export class AgentService {
  ...
  async createEmployee(body: CreateAgentDto) {
    ...
    const data = {
      message: `Congratulations! Welcome to Anamika Capital Finance Pvt. Ltd. Your Joining has been Accepted By Company. Your Login ID ${a_id} And Password is ${body.password}`,
      numbers: body.Phone
    }
